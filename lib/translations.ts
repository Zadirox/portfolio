...
export const translations = {
  ru: {
    ...
    hero: {
      ...
      name: "Dmitry",
      role: "Вайб-кодер",
      subtitle: "AI-ускоренная разработка: от идеи до рабочего продукта за дни, а не недели. Telegram-боты, веб-приложения, автоматизация бизнес-процессов.",
      cta_github: "GitHub",
    ...
    footer: {
      built_with: "Сделано с помощью AI и",
      by: "Zadirox",
    },
  },
  en: {
    ...
    hero: {
      ...
      name: "Dmitry",
      role: "Vibe Coder",
      subtitle: "AI-accelerated development: from idea to working product in days, not weeks. Telegram bots, web apps, business automation.",
      cta_github: "GitHub",
